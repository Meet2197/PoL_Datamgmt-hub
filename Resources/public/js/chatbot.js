...
async function callGeminiAPI(prompt) {
    ...
    // --- "What is..." questions (expanded) ---
        ...
        responseText = "Zenodo is a general-purpose open-access repository by CERN, providing persistent identifiers (DOIs) for research data. It's recommended for data sharing and archiving. Official website: <a href='https://zenodo.org/' target='_blank' class='text-blue-500 dark:text-blue-300 hover:underline'>https://zenodo.org/</a>. More info: <a href='./archiving.html' target='_blank' class='text-blue-500 dark:text-blue-300 hover:underline'>archiving.html</a>.";
        ...
        responseText = "OwnCloud TUD is a recommended tool for secure cloud storage specifically for TU Dresden users. It offers benefits like accessibility and syncing. Find more details on the <a href='./backup.html' target='_blank' class='text-blue-500 dark:text-blue-300 hover:underline'>Data Storage & Backup page</a>.";
        ...
        responseText = "OpARA is the open-access data repository at TU Dresden, recommended for data sharing and archiving. You can find it mentioned on the <a href='./archiving.html' target='_blank' class='text-blue-500 dark:text-blue-300 hover:underline'>Data Sharing & Archiving page</a>. For TU Dresden's official OpARA site, you might check the <a href='https://tu-dresden.de/forschung/services-forschende/forschungsdatenmanagement' target='_blank' class='text-blue-500 dark:text-blue-300 hover:underline'>TU Dresden Research Data Management page</a>.";
    } else if (lowerCasePrompt.includes("what are interoperability standards") || lowerCasePrompt.includes("interoperability standards")) {
        responseText = "Interoperability standards like FHIR, UCUM, LOINC, and SNOMED CT are crucial for consistent data exchange and management, especially in specific fields like health data. They are discussed on the <a href='./regulations.html' target='_blank' class='text-blue-500 dark:text-blue-300 hover:underline'>EU & German Data Regulations page</a>.";
    } else if (lowerCasePrompt.includes("what is the 3-2-1 backup strategy") || lowerCasePrompt.includes("3-2-1 backup")) {
        responseText = "The 3-2-1 backup strategy is a robust approach mentioned on the <a href='./backup.html' target='_blank' class='text-blue-500 dark:text-blue-300 hover:underline'>Data Storage & Backup page</a>. It recommends having at least 3 copies of your data, stored on 2 different types of media, with 1 copy off-site for disaster recovery.";
        ...
        responseText = "Metadata Management is crucial for making data Findable and Interoperable (part of FAIR Principles). It involves creating and maintaining descriptive information about your data. This is covered in the <a href='./regulations.html' target='_blank' class='text-blue-500 dark:text-blue-300 hover:underline'>'EU & German Data Regulations' section</a>.";
    } else if (lowerCasePrompt.includes("what is image data management") || lowerCasePrompt.includes("image data")) {
        responseText = "Image Data Management is a specific topic addressed under EU & German Data Regulations, highlighting best practices for handling image-based research data. You can find more details here: <a href='./regulations.html' target='_blank' class='text-blue-500 dark:text-blue-300 hover:underline'>regulations.html</a>.";
    } else if (lowerCasePrompt.includes("what is fhir")) {
        responseText = "FHIR (Fast Healthcare Interoperability Resources) is an interoperability standard mentioned in the <a href='./regulations.html' target='_blank' class='text-blue-500 dark:text-blue-300 hover:underline'>'EU & German Data Regulations' page</a>, primarily for health data exchange.";
    } else if (lowerCasePrompt.includes("what is ucum")) {
        responseText = "UCUM (Unified Code for Units of Measure) is a standard for consistent measurement units, discussed on the <a href='./regulations.html' target='_blank' class='text-blue-500 dark:text-blue-300 hover:underline'>EU & German Data Regulations page</a>.";
    } else if (lowerCasePrompt.includes("what is loinc")) {
        responseText = "LOINC (Logical Observation Identifiers Names and Codes) is a standard for medical lab results, covered on the <a href='./regulations.html' target='_blank' class='text-blue-500 dark:text-blue-300 hover:underline'>EU & German Data Regulations page</a>.";
    } else if (lowerCasePrompt.includes("what is snomed ct")) {
        responseText = "SNOMED CT is a globally recognized clinical terminology for electronic health records, mentioned on the <a href='./regulations.html' target='_blank' class='text-blue-500 dark:text-blue-300 hover:underline'>EU & German Data Regulations page</a>.";
    } else {
