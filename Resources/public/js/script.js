document.addEventListener('DOMContentLoaded', () => {
    ...
    const toolsData = [
        { name: 'Zenodo', link: 'https://zenodo.org/', logo: 'Resources/images/logos/zenodo_logo.jpg', description: 'A general-purpose open-access repository for research data, software, publications, and more.', documentation: 'zenodo.html', join: 'https://zenodo.org/signup/' },
        { name: 'Figshare', link: 'https://figshare.com/', logo: 'Resources/images/logos/imagesc-logo.png', description: 'An online repository to share, publish, and discover research data, figures, and other scholarly outputs.', documentation: 'figshare.html', join: 'https://figshare.com/account/login' },
        { name: 'elabftw', link: 'https://elab.cmcb.tu-dresden.de/', logo: 'Resources/images/logos/elabftw-logo.png', description: 'An open-source electronic lab notebook for recording and managing experimental data.', documentation: 'elabftw.html', join: 'https://elab.cmcb.tu-dresden.de/login.php' },
        { name: 'Gitlab TUD', link: 'https://gitlab.mn.tu-dresden.de/', logo: 'Resources/images/logos/gitlab-logo.png', description: 'TU Dresden\'s platform for Git-based version control, code collaboration, and CI/CD.', documentation: 'gitlab.html', join: 'https://gitlab.mn.tu-dresden.de/users/sign_in' },
        { name: 'OpARA TUD', link: 'https://opara.zih.tu-dresden.de/home', logo: 'Resources/images/logos/opara-logo.png', description: 'TU Dresden\'s institutional repository for publications and research data, ensuring long-term accessibility.', documentation: 'OPARA.html', join: 'https://opara.zih.tu-dresden.de/login' },
        { name: 'BioImage Archive', link: 'https://www.ebi.ac.uk/bioimage-archive/help-policies/', logo: 'Resources/images/logos/bioimage-archive-logo.png', description: 'EMBL supported Large-scale, centralised data resource to host reference imaging data.', documentation: 'Bioimagearchieve.html', join: 'https://www.ebi.ac.uk/biostudies/submissions/signin' },
        { name: 'PRIDE Database', link: 'https://www.ebi.ac.uk/pride/', logo: 'Resources/images/logos/pride_logo.png', description: 'PRoteomics Archive database is data repository for mass spectrometry proteomics data.', documentation: 'pride_database.html', join: 'https://www.ebi.ac.uk/pride/login'},
    ];
