document.addEventListener('DOMContentLoaded', () => {
    ...
    const toolsData = [
        ...
        { name: 'EGA Archieve', logo: 'Resources/images/logos/ega.png', description: 'service for permanent archiving and sharing of personally identifiable genetic, phenotypic, and clinical data ', documentation: 'https://ega-archive.org/about/ega/', join: 'https://ega-archive.org/register/' },
